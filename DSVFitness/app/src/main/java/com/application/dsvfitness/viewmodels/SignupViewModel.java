...
import com.application.dsvfitness.models.User;
import com.application.dsvfitness.utils.AuthResource;
...
public class SignupViewModel extends ViewModel {
    ...
    public void signup(String email, String password, String weight, String height, String level) {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password)
                .addOnSuccessListener(authResult -> {
                    if (authResult.getUser() != null) {
                        ...
                        hashMap.put(Constants.HEIGHT, height);
                        hashMap.put(Constants.WEIGHT, weight);
                        hashMap.put(Constants.LEVEL, level);
